import VFS from './../assets/external/VFSPortfolio.pdf'
...
},
{
	...
	"link": [{
		"type": "Repo",
		"endpoint": "https://github.com/jeremy8rivera/Social-Calendar"
	}]
},
{
	"key": "twittertranslation",
	"name": "Twitter Translation Bot",
	"description": "Twitter automated bot that translates tweets when mentioned in a comment thread. The bot will call Twitter API to read the tweet, then calling from a Google Translate API with the data it recieved from the tweet. Finally, it will post to the tweet chain the recieved data.",
	"languages": "Node.JS, JavaScript",
	"link": [{
		"type": "Repo",
		"endpoint": "https://github.com/jeremy8rivera/TwitterTranslationBot"
	}],
},
{
	"key": "introvocial",
	"name": "Introvocial",
	"description": "An attempt at creating a social hangout with accounts, stored on a firebase database. Once signed in, users have a live conversation with one another and can view a live updating graph, using google charts, of their answers to poll question.",
	"languages": "HTML, CSS, JQuery, Node.JS",
	"link": [{
		"type": "Repo",
		"endpoint": "https://github.com/jeremy8rivera/Introvocial"
	}]
},
{
	"key": "terp",
	"name": "Terp Company Design",
	"description": "Developed and created a fake music production company for an Integrated Digital Media course. Went through the process of creating a logo, physical application, and a digital application. PDF is shortened to only include projects from the class.",
	"languages": "Illustrator, Indesign, Photoshop",
	"link": [{
		"type": "PDF",
		"endpoint": VFS		
	}]
},
{
	...
	"link": [{
		"type": "Repo",
		"endpoint": "https://github.com/JamesStuartBeck/Thin-Ice/tree/final"
	}]
}
